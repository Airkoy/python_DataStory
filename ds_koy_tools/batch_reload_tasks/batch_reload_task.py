...
ENVIRONMENT_CONFIG = {
    "dev": {
        ...
        "detail_params": {},
        "run_url": "http://dc.dev.datastory.com.cn/application/market/job/v1/run",
    ...
    "prod": {
        ...
        "run_url": "https://dc.datastory.com.cn/application/market/job/v1/run",
