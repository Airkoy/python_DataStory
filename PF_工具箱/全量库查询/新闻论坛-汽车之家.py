...
headers = {
    "Authorization": "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJrb3lAZGF0YXN0b3J5LmNvbS5jbiIsImF1ZGllbmNlIjoid2ViIiwiY3JlYXRlZCI6MTc2OTUwNTA1NzQ0OSwicHciOiJBaXIxNjA2MzAiLCJleHAiOjE3NzAxMDk4NTd9.XL6a4fDK5r7wMYXBF2tcZGWekrRUEvfucbDYKc-Smo6Cmy-AdB2fh1zkNRqMjT4TnnT5jlI2G2fZT4Tyj22FRQ",
...
payload = json.dumps({
  ...
  "needReturnFields":"comment_cnt,update_timestamp",
  "searchCondition": [
    {
      "fieldName": "item_id",
      "operation": "eq",
      "fieldValue": ["fb2d57f4877c84c804efaadc86175563"]
    },
    {
      "fieldName": "publish_timestamp",
      "operation": "ltegte",
      "fieldValue": [1735660800000, 1769529599000]
    }
  ],
  "sortCondition": {
  ...
  "timeRange": "1735660800000, 1769529599000"
})
