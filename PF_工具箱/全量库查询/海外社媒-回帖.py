...
payload = json.dumps({
    ...
    "needReturnFields": "forum_name,site_name,forum_id,site_id",
    "searchCondition": [
        {"fieldName": "site_id","operation": "eq","fieldValue": ["1228001"]},  # discord 1244261897 reddit 1228001
        ...
        {"fieldName": "forum_name", "operation": "mp", "fieldValue": ["Arknights Official"]},
        # {"fieldName": "forum_id", "operation": "eq", "fieldValue": ["586503387072167937"]},
        {
